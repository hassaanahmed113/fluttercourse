...
var pdeal = ['assets/pd1.PNG'];
var ptitle = ['Promo Lasagne'];
var pprice = ['623.20'];

class promodeal extends StatefulWidget {
  const promodeal({super.key});

  @override
  State<promodeal> createState() => _promodealState();
}

class _promodealState extends State<promodeal> {
  @override
